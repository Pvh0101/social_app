# Biểu Đồ Tuần Tự Sử Dụng Mermaid

Tài liệu này chứa các biểu đồ tuần tự cho 14 chức năng chính của ứng dụng Social App, được biểu diễn bằng cú pháp Mermaid.
...
sequenceDiagram
    ...
    Note over DB: Firebase gửi thông báo đẩy đến người nhận
```
